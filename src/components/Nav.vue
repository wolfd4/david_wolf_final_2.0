    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <ul class="navbar-nav">
            <li class="nav-item">
             ...
             <li class="nav-item">
                <router-link class="nav-link" exact-active-class="active" to="/myinfo">My Information</router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <router-link class="nav-link" exact-active-class="active" to="/final">Final</router-link>
            </li>
        </ul>
    </nav>
</template>
